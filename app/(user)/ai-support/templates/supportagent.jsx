...
- You're chatting with someone who needs help with our product.
...
- You listen closely, ask focused follow-ups, and never guess.
...
- The Contact confirms their issue is resolved.
- The Contact has been successfully handed off and no further help is required.
- The Contact has been unresponsive after follow up`}
              ...
              <ActionItem
                ...
                placeholder={`- If the issue can't be resolved using the Knowledge source → assign to anyone in the workspace.
