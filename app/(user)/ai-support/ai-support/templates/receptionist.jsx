...
export default function Receptionist({ onBack, onUseRecep }) {
              ...
              <div className="w-200 pr-4 bg-white/5 border border-white/10 rounded-3xl p-6 backdrop-blur-xl duration-300">
                ...
                <ul className="text-sm text-white/80 leading-relaxed space-y-2 list-disc pl-4">
                  <li>
                    ...
                    details, and efficiently routes conversations to the right
                    team or person for further assistance.
                  </li>
                  <li>
                    Best suited for teams that want to stay responsive at scale
                    and making sure every message reaches the right team without
                    delay.
                  </li>
                </ul>
                ...
                <div className="mt-6">
                  ...
                  <ul className="text-sm text-white/70 space-y-1 list-disc pl-4">
                    <li>
                      Clearly define which team or agent each inquiry should
                      route to.
                    </li>
                    <li>
                      Add questions that clearly collect the information your
                      team needs.
                    </li>
                    <li>Test routing rules carefully before launching.</li>
                  </ul>
                </div>
