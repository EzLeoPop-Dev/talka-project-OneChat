...
export default function LoginPage() {
  ...
  const handleSubmit = (e) => {
    ...
    if (isSuccess) {
      setTimeout(() => router.push("/Creatworkspace/workspace"), 2000);
    }
  };
            ...
            <form className="w-full space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="pt-2 space-y-3">
                ...
                <Link href="/auth/register">
                  <button className="w-full bg-white text-purple-700 py-2.5 rounded-full hover:bg-gray-200 transition shadow-sm">สมัครสมาชิก</button>
                </Link>
              </div>
