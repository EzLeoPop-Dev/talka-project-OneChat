  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex justify-center items-center z-50">
      <div className="relative bg-[#12131a] text-white w-[550px] rounded-2xl border border-white/20 shadow-2xl p-6 md:p-8">
        ...
        {/* Assign Tasks */}
        <div className="mb-5">
          <label className="block text-sm mb-2">Assign Tasks</label>
          ...
          <div className="flex gap-2 mb-3">
            ...
            <button
              onClick={() => {
                ...
                if (!trimmed) return;
                setTeamTasks([...teamTasks, trimmed]);
                setNewTask("");
              }}
              className="bg-white/20 border border-white/40 text-white px-4 rounded-lg hover:bg-white/30"
            >
              Add
            </button>
          </div>
          ...
          {/* Task List */}
          <div className="bg-[#1c1d25] border border-white/30 rounded-lg p-3 h-[120px] overflow-y-auto">
            {teamTasks.length === 0 ? (
              ...
              teamTasks.map((task, index) => (
                <div
                  key={index}
                  className="flex justify-between items-center bg-white/10 px-3 py-2 rounded-lg mb-2"
                >
